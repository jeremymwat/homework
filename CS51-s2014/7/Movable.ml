...
object (self)
  ...
  initializer
    ...
    | Some s ->  self#register_handler (Event51.buffer s World.move_event) self#do_move
    | None -> ()
  ...
  (* ### TODO: Part 2 Movement ### *)
  method private do_move a =ignore(a); ignore( super#move self#next_direction)
  ...
  (* ### TODO: Part 2 Movement ### *)
  method next_direction = Some Direction.North
