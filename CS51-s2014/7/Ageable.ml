...
object (self)
  ...
  (* ### TODO: Part 4 Aging ### *)
  method private do_age () = lifetime  <- lifetime - 1;
  if lifetime <= 0 then ignore(self#die) else ()

  (**************************)
  (***** Helper Methods *****)
  (**************************)

  method private draw_life : unit =  let v = 
		        Float.of_int lifetime /. Float.of_int max_lifetime 
		           in self#draw_status_bar Graphics.red v
  ...
  (* ### TODO: Part 4 Aging ### *)
  method draw_picture : unit = super#draw_circle Graphics.white Graphics.black "X"
