...
let name : (string * string) = ("Jeremy", "Watson");;
...
let class_year : year = Other "Extension student";;

(* 1.c. Replace the .... with what you're excited about in this course *)
let exciting : string = "I am excited about learning to write good code, not just code, and I look forward to gaining a deeper and more intuitive understanding of recursion";;
